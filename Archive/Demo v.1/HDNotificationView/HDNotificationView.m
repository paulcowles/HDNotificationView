...
- (void)setUpUI
{
    if ([[[UIDevice currentDevice] systemVersion] doubleValue] >= 7.0) {
        self.barTintColor = [[SSUIConfigManager sharedInstance] ColorFromConfigurationKeyPath:@"NotificationBars.TintColor"];
    ...
    _imgIcon.tintColor = [[SSUIConfigManager sharedInstance] ColorFromConfigurationKeyPath:@"NotificationBars.TitleColor"];
    ...
    [_lblTitle setTextColor:[[SSUIConfigManager sharedInstance] ColorFromConfigurationKeyPath:@"NotificationBars.TitleColor"]];
    ...
    [_lblMessage setTextColor:[[SSUIConfigManager sharedInstance] ColorFromConfigurationKeyPath:@"NotificationBars.TextColor"]];
